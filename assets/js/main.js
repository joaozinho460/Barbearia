/* ============================================================================
BARBEARIA RICKGINO · INTERAÇÕES GLOBAIS + PERFIL / LOGIN + SUPABASE
============================================================================= */
...
(function () {
  ...
  async function updateUserInterface() {
    ...
    try {
      ...
      if (data && data.user) {
        await showLoggedInState(data.user);
      } else {
        showLoggedOutState();
      }
